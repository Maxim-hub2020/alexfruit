  ...
  return (
    <MainShell user={user}>
      <section className="section-shell relative isolate min-h-[calc(100vh-8rem)] py-8">
        <div
          aria-hidden="true"
          className="fixed inset-0 z-30 bg-[#eef5eb]/72 backdrop-blur-[10px]"
        />
        <div
          aria-hidden="true"
          className="fixed inset-0 z-30 bg-[radial-gradient(circle_at_50%_18%,rgba(255,255,255,0.45),transparent_30%),linear-gradient(180deg,rgba(245,248,240,0.42),rgba(238,245,235,0.8))]"
        />
        ...
        <div className="relative z-40 mx-auto max-w-xl rounded-[2.5rem] border border-white/72 bg-white/86 p-8 shadow-[0_34px_100px_rgba(23,50,38,0.22)] backdrop-blur-2xl">
